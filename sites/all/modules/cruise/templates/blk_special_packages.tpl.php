...
<div class="homePackages">
    <div class="container1">
        <div class="title1"><span>Special packages</span></div>
        <div class="showDesktop">
            <div class="homePackages__group">
                <div class="homePackages__row">
                    <?php if(isset($data['cruise']) && count($data['cruise']) > 0):?>
                    ...
                    <div class="homePackages__item">
                        <div class="offers">
                            <div class="packages__img">
                                <img src="<?php echo $ob['cruise_img'][0]?>">
                                <div class="packages__name"><p><?php echo $ob['cruise_name']?></p></div>
                            </div>
                            <div class="packages__cont">
                                <div class="offers__top">
                                    <p class="text16 medium blueDark"><?php echo $ob['title']?></p>
                                    <p class="text14 blueDark"><?php echo truncate_utf8($ob['cruise_overview'],100,true)?></p>
                                    <button class="medium orgColor packages__more">View more<svg xmlns="http://www.w3.org/2000/svg" width="16" height="8" viewBox="0 0 16 8" fill="none">
